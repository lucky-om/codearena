/**
 * Index.tsx — Code Arena Landing Page
 * Developed by: Lucky
 * Project: Code Arena — Wildcard Draw System (Inferno'26)
 * Description: Hero landing page showcasing the Wildcard Draw System.
 *              Features animated particles, cyber card reveal, and CTA to
 *              the draw page. Sound-enabled with Web Audio API.
 */
...
export default function Index() {
  ...
  return (
    <div className="min-h-screen grid-bg overflow-hidden">
      ...
      <footer className="border-t border-neon-cyan/30 backdrop-blur-sm text-center py-4 relative z-10 space-y-1">
        <motion.p
